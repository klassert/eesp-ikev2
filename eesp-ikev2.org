...
document specifies negotiation of version 0 of EESP.
#+end_abstract
...
unspecfied for ESP and MUST NOT be used in ESP proposals.
...
are unspecfied for EESPv0 and MUST NOT be used in EESPv0 proposals.
