...
#+begin_abstract
This document specifies how to negotiate the use of the Enhanced
...
[[I-D.ietf-ipsecme-eesp]], introduces enhancements to the
...
[[I-D.ietf-ipsecme-eesp]]). The Sub SA ID MUST be unique for
...
Current EESP specification [[I-D.ietf-ipsecme-eesp]] defines
...
# which is specified in [[I-D.ietf-ipsecme-eesp]],
...
The EESP Crypt Offset Option (see Section "EESP Crypt Offset Option" of
[[I-D.ietf-ipsecme-eesp]]) allows controlled exposure of leading
bytes of the inner packet for specific deployments (e.g., data
center telemetry/processing). Its use and the maximum allowed
Crypt Offset are negotiated (see [[Announcing Maximum Crypt Offset]]).
